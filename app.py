...
def menu():
    with st.sidebar:
        selection = option_menu(menu_title=None, options=["Menu principal", "Notes"], icons=['house', 'palette2'])
...
selection = menu()
if selection == "Menu principal":
    #image d'accueil :
    fond_accueil = "fond_logos.png"
    st.image(fond_accueil, caption=None, width=None, clamp=False, channels="RGB", output_format="auto", use_container_width=True)
